...
import {
  ...
  SummaryBox,
  loadPdfLibs,
  getPHQ9SeverityColor,
  getPHQ9ScoreColor,
  PHQ9_SEVERITY_CONFIG,
} from "./AssessmentComponents";

// ---- PHQ-9 Report Card Component ----
export default function PHQ9ReportCard({ loading, error, report, onRetry }) {
        ...
        <div>
          ...
          <div className="space-y-1.5 sm:space-y-2">
            {question_details && Object.entries(question_details).map(([qId, detail]) => {
              ...
              const scoreColor = getPHQ9ScoreColor(score);
              return (
